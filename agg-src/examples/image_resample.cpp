    ...
    void on_draw() override
    {
        ...
        switch(m_trans_type.cur_item())
        {
            case 0:
            {
                ...
                using span_gen_type = agg::span_image_filter_rgba_2x2<source_type, interpolator_type>;
            ...
            case 1:
            {
                ...
                using interpolator_type = agg::span_interpolator_linear<>;
                using span_gen_type = agg::span_image_resample_rgba_affine<source_type>;
            ...
            case 4:
            {
              ...
              if (interpolator.is_valid()) {
                using span_gen_type = agg::span_image_resample_rgba<source_type, subdiv_adaptor_type>;
