...
//------------------------------------------------------------------------
bspline::bspline(int num) : m_max(0),
                            m_num(0),
                            m_x(nullptr),
                            m_y(nullptr),
                            m_last_idx(-1)
...
//------------------------------------------------------------------------
bspline::bspline(int num, const double *x, const double *y) : m_max(0),
                                                              m_num(0),
                                                              m_x(nullptr),
                                                              m_y(nullptr),
                                                              m_last_idx(-1)
...
double bspline::interpolation(double x, int i) const
{
  ...
  double r = m_x[i] - x;
  double p = d * d / 6.0;
  return (m_am[j] * r * r * r + m_am[i] * h * h * h) / 6.0 / d + ((m_y[j] - m_am[j] * p) * r + (m_y[i] - m_am[i] * p) * h) / d;
}
