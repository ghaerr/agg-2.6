...
namespace agg
{
    ...
    unsigned gamma_ctrl_impl::vertex(double* x, double* y)
    {
        ...
        case 1:
          if (m_vertex == 0 || m_vertex == 4 || m_vertex == 8) {
            cmd = path_cmd_move_to;
          }
          if (m_vertex >= 12) {
            cmd = path_cmd_stop;
        ...
        case 3:
          if (m_vertex == 0 || m_vertex == 4 || m_vertex == 8 || m_vertex == 14) {
            cmd = path_cmd_move_to;
          }
    ...
    //------------------------------------------------------------------------
    bool gamma_ctrl_impl::on_mouse_button_up(double /*x*/, double /*y*/)
    {
      if (m_mouse_point != 0U) {
        m_mouse_point = 0;
        return true;
